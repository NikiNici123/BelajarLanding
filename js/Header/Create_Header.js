...
coba_Menu().then(menu => {
    for(let i = 0; i<menu.Header.length;i++) {
        ...
        elemen.setAttribute('class', ` ${menu.Header[i].class} group  right-0 border-slate-700 border-2 px-2 py-1 lg:px-5 lg:py-3 lg:block rounded-md hover:bg-slate-500 hover:border-white hover:text-red-300 hover:rounded-2xl hover:shadow-2xl hover:shadow-slate-200 transition-all duration-300 ease-in-out`)
